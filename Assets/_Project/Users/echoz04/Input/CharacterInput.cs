...
//     version 1.14.2
//     from Assets/_Project/Users/echoz04/Input/CharacterInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_Project/Users/echoz04/Input/CharacterInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CharacterInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Movement"",
            ""id"": ""cc4d2aa4-7f5e-4a56-8ada-6f86ca018421"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""b86eae74-5af3-4b5b-b25a-b7a10eb4a68c"",
                ...
                },
                {
                    ""name"": ""Look"",
                    ""type"": ""Value"",
                    ""id"": ""de8ce9c5-28b9-41ef-86ac-fe5f8f8122ae"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""48486e85-bc68-407b-ab6d-de5480e43b2d"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""fc4b76e4-5ef5-4230-b9f4-769d4a185f71"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""e361fa43-41df-4560-99d9-af8921309f25"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""8f29809d-abc0-4813-9c2d-bb16822d35e0"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""1ccdf444-ac34-4052-a938-2f4a9843a9c6"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""80d048d4-bf9b-4686-9730-10c9b70e1f2b"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""5aba0d87-2bde-4f6d-90ee-b360f1706bbd"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""d8251948-4af0-4ef5-8e83-e11aec5476c7"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        {
            ""name"": ""Interactive"",
            ""id"": ""c33353d0-bcd4-4e1e-b46b-2dae8b726133"",
            ""actions"": [
                {
                    ""name"": ""Interact"",
                    ""type"": ""Button"",
                    ""id"": ""9edb8acf-dba9-4e5a-b226-2fe6128a310b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Reload"",
                    ""type"": ""Button"",
                    ""id"": ""0f969fd4-1e4b-486d-9a5b-f99d71c10694"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""25c07972-ba4a-4118-b7aa-c5da6721571f"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""1c4fafa7-dcfd-4397-a191-6325d566852c"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@CharacterInput()
    {
        ...
        UnityEngine.Debug.Assert(!m_Interactive.enabled, "This will cause a leak and performance issues, CharacterInput.Interactive.Disable() has not been called.");
    }
    ...
    public struct InteractiveActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public InteractiveActions(@CharacterInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Interactive/Interact".
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="InteractiveActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="InteractiveActions" />
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="InteractiveActions.UnregisterCallbacks(IInteractiveActions)" />.
        /// </summary>
        /// <seealso cref="InteractiveActions.UnregisterCallbacks(IInteractiveActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="InteractiveActions.AddCallbacks(IInteractiveActions)" />
        /// <seealso cref="InteractiveActions.RemoveCallbacks(IInteractiveActions)" />
        /// <seealso cref="InteractiveActions.UnregisterCallbacks(IInteractiveActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="InteractiveActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Interactive" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="InteractiveActions.AddCallbacks(IInteractiveActions)" />
    /// <seealso cref="InteractiveActions.RemoveCallbacks(IInteractiveActions)" />
